SHELL BASICS DAY 1 at ALX school
...
102-tree - Create a script that creates the directories welcome/, welcome/to/ and welcome/to/my_first_directory in the current directory. You are only allowed to use two spaces in your script, not more.
